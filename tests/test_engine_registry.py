"""Unit tests for napari_app.engine_registry.
...
napari_app.engines — the module owning the two built-in engines — registers
...
from napari_app.engine_registry import EngineSpec
...
# ── Built-in engines (napari_app.engines) ─────────────────────────────────────

def test_builtin_engines_are_registered():
    import napari_app.engines  # noqa: F401 — triggers registration
...
def test_builtin_cellseg1_labels():
    import napari_app.engines  # noqa: F401
